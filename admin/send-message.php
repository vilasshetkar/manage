...
<?php if (!isset($thank) && !isset($_GET['r_proj'])){ ?>
...
<?php } ?>
<?php } ?>
<?php if ($respo_for !='web'){
	//content() ;
	
	}
?>

<?php if (!isset($_GET['r_proj'])){
function title(){
if(isset($_GET['MOD'])){
	$id= $_GET['MOD'];
	}
	echo 'Jaidev Landmarks | Send Enquiry';
	}
...
<meta name="keywords" content="Jaidev Landmarks | Send Enquiry" />
<meta name="description" content="Jaidev Landmarks | Send Enquiry" />
