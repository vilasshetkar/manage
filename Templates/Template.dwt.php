...
$result = mysql_query("SELECT * FROM `user_sites` WHERE id=".$_SESSION['domain']);
    ...
    <table width="100%" border="0" cellpadding="0" cellspacing="0">
      <tr>
        ...
        <div class="sidebar1">
          <ul class="nav">
            <li><a href="../manage/index.php">Home</a></li>
            <li><a href="../manage/insert/editcategory.php"> Category </a></li>
            <li><a href="../manage/insert/editarticle.php"> Article</a></li>
            <li><a href="../manage/insert/menutype.php">Menu Type</a></li>
            <li><a href="../manage/insert/editmenu.php"> Menu</a></li>
            <li> <a href="../manage/upload/upload.php"> Media</a></li>
            <li><a href="../manage/module/ad_management/view-ads.php">Ad Management</a></li>
            <li><a href="../manage/module/view-module.php">Modules</a> </li>
            <li> <a href="../manage/login/logout.php">Log Out</a> </li>
            <p>
              <?php
if (checkAdmin()) {
/*******************************END**************************/
?>
            ...
            <p>&nbsp; </p>
            <p> <a href="../manage/login/admin.php">Admin CP </a></p>
            <?php } ?>
          </ul>
          <p></p>
          <!-- end .sidebar1 -->
          ...
          <ul class="mainmenu">
            <li><a href="../manage/Projects/Real-Estate/responses.php">My Responses</a>
              <ul>
                ...
                <li><a href="../manage/Projects/Real-Estate/responses.php?respo_for=refer">Refer Friends</a></li>
...
<!-- TemplateBeginEditable name="content" -->
          ...
          <table border="0" cellspacing="5" class="border cellborder">
            <tr>
              ...
              <td scope="col"><a href="#" class="nav">fsdaf</a></td>
              <th scope="col">&nbsp;</th>
            </tr>
          </table>
          <p>&nbsp;</p>
