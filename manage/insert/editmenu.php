      ...
      <tr>
        ...
        <div class="sidebar1">
          <ul class="nav">
            ...
            <li><a href="editcategory.php"> Category </a></li>
            <li><a href="editarticle.php"> Article</a></li>
            <li><a href="menutype.php">Menu Type</a></li>
...
$sql="UPDATE $_SESSION[user_id]_menu SET menu_name='$_POST[menu_name]', link='$_POST[link]', parent=$_POST[parent], menu_type='$_POST[menu_type]' WHERE id=".$_POST['id'];
if (!mysql_query($sql))
  {
  die('Error: ' . mysql_error());
  }
echo "<h1 align='center'>1 record Updated</h1>";
echo '</br><b><h2 align="center"><a href="javascript:window.close()">Close</a></b></h2>';
...
$result= mysql_query("DELETE FROM `$_SESSION[user_id]_menu` WHERE id=".$_GET['DEL']);
...
<!-- ************Edit Menu Function ************************************************************************************ -->
<?php 
$result = mysql_query("SELECT * FROM `$_SESSION[user_id]_menu` WHERE domain='$_SESSION[domain]'");
?>
<table width="100%" border="0" align="center" cellspacing="5">
  <tr>
      <td width="16%"><a href="newmenu.php" class="nav">New Menu</a></td>
  ...
  <table width="86%" border="1" align="center" cellpadding="5" cellspacing="0" class="border cellborder"  id="menutbl">
    <tr>
  <th width="7%">
Menu ID  </th>
  <th colspan="3">
Menu Name  </th>
  ...
  <?php		  	
	...
	while($row = mysql_fetch_array($result)){ ?>
  <tr>
  <td width="7%" align="center" valign="middle" id="editmenu">
  <?php  echo $i++; ?>
  </td>
  <td width="7%" align="center" valign="middle">
  <a href="updatemenu.php?UID=<?php echo $row['id'];?>&amp;CAT=<?php echo $row['category'];?>&amp;LINK=<?php echo $row['link'];?>&amp;PARENT=<?php echo $row['parent'];?>&amp;MT=<?php echo $row['menu_type'];?>" class="nav" id="mname">Edit</a></td>
  <td width="9%" align="center" valign="middle"><a href="?DEL=<?php echo $row['id'];?>" class="nav" id="delete">Delete</a></td>
  <td width="42%" align="left" valign="middle"><?php echo $row['menu_name'];?></td>
  <td width="20%" align="left" valign="middle"><?php echo $row['link'];?></td>
