      ...
      <tr>
        ...
        <div class="sidebar1">
          <ul class="nav">
            ...
            <li><a href="view-ads.php">Ad Management</a></li>
...
if(isset($_POST['ad_id'])){
	$sql = mysql_query("UPDATE `ads` SET `ad_name`='$_POST[ad_name]', `ad_type`='$_POST[ad_type]', `ad_size`='$_POST[ad_size]', `ad_content`='$_POST[content]', `ad_link`='$_POST[ad_link]', `status`= '$_POST[status]' WHERE id=$_GET[ad]") or die(mysql_error());
	if($sql){
		$msg = '<h2><font color="#990000">One advertisement has <strong>updated</strong> successfully!</font></h2>';
		echo $msg;
		}
}
?>
<?php if(!isset($msg) && isset($_GET['ad'])){ 
	$edit = mysql_query("SELECT * FROM `ads` WHERE id = $_GET[ad] AND domain = $_SESSION[domain] AND user = $_SESSION[user_id]") or die(mysql_error());
...
<form action="" method="post" enctype="multipart/form-data" name="form1" id="form1">
  <table border="0" cellpadding="0" cellspacing="0" class="border cellborder">
    ...
    <tr>
      ...
      <td colspan="3" align="left" valign="top"><input name="ad_name" type="text" id="ad_name" value="<?php echo $e_row['ad_name'];?>" size="40" /></td>
    </tr>
    <tr>
      ...
      <td colspan="3" align="left" valign="top"><input name="status" type="radio" id="Publish" value="1" <?php if($e_row['status']==1) echo 'CHECKED' ?>/>
        Publish 
          <input type="radio" name="status" id="Publish" value="0" <?php if($e_row['status']==0) echo 'CHECKED' ?> />
UnPublish</td>
    </tr>
    <tr>
      <td align="left" valign="top">Ad Type:</td>
      <td colspan="3" align="left" valign="top"><span id="spryselect1">
      <select name="ad_type" id="ad_type">
        <option value="Vertical" <?php if($e_row['ad_type']=='Vertical') echo 'SELECTED' ?>>Vertical</option>
        <option value="Horizontal" <?php if($e_row['ad_type']=='Horizontal') echo 'SELECTED' ?>>Horizontal</option>
      </select>
      <span class="selectRequiredMsg">Please select an item.</span></span></td>
    </tr>
    <tr>
      <td width="15%" align="left" valign="top"><p>Ad Size:</p></td>
      <td colspan="3" align="left" valign="top"><select name="ad_size" class="ad_size" id="Horizontal_size">
        <option value="">Select Ad Size</option>
          <option value="200 x 100" <?php if($e_row['ad_size']=="200 x 100") echo 'SELECTED' ?>>200 x 100</option>
          <option value="300 x 100" <?php if($e_row['ad_size']=="300 x 100") echo 'SELECTED' ?>>300 x 100</option>
          <option value="500 x 100" <?php if($e_row['ad_size']=="500 x 100") echo 'SELECTED' ?>>500 x 100</option>
          <option value="800 x 100" <?php if($e_row['ad_size']=="800 x 100") echo 'SELECTED' ?>>800 x 100</option>
      </select>
        <select name="ad_size" class="ad_size" id="Vertical_size">
          <option value="">Select Ad Size</option>
          <option value="200 x 100" <?php if($e_row['ad_size']=="200 x 100") echo 'SELECTED' ?>>200 x 100</option>
          <option value="200 x 200" <?php if($e_row['ad_size']=="200 x 200") echo 'SELECTED' ?>>200 x 200</option>
          <option value="200 x 300" <?php if($e_row['ad_size']=="200 x 300") echo 'SELECTED' ?>>200 x 300</option>
          <option value="200 x 500" <?php if($e_row['ad_size']=="200 x 500") echo 'SELECTED' ?>>200 x 500</option>
        </select></td>
    </tr>
    <tr>
      ...
      <td colspan="3" align="left" valign="top"><span id="ad-text">
        <textarea name="content" id="content" cols="55" rows="20"><?php echo $e_row['ad_content'];?></textarea>
        </span></td>
    </tr>
    <tr>
      <td align="left" valign="top">Ad Link:</td>
      <td colspan="3" align="left" valign="top"><input name="ad_link" type="text" id="ad_link" size="40" value="<?php echo $e_row['ad_link'];?>" /> 
        (Type here your ads redirect link.)</td>
    </tr>
    <tr>
      <td align="left" valign="top">&nbsp;</td>
      <td colspan="3" align="left" valign="top">
      <input name="ad_id" type="hidden" id="ad_id" size="40" value="<?php echo $e_row['id'];?>" />
