...
// This function is used for displaying submenu with jQuery and css ***************************************************
	...
	<div class="project-detail">
	  ...
	  <ul class="navigation">
	    <li><a href="jacascript:void();" onclick="$('.width-thirty').hide();$('#overview').slideDown(1000);">Overview </a></li>
	    <li><a href="jacascript:void();" onclick="$('.width-thirty').hide();$('#amenities').slideDown(1000);">Amenities/Features</a></li>
	    <li><a href="jacascript:void();" onclick="$('.width-thirty').hide();$('#specifications').slideDown(1000);">Specifications </a></li>
	    <li><a href="jacascript:void();" onclick="$('.width-thirty').hide();$('#location-map').slideDown(1000);">Location Map</a></li>
	    <li><a href="jacascript:void();" onclick="$('.width-thirty').hide();$('#layout-plan').slideDown(1000);">Layout Map</a></li>
	    <li><a href="jacascript:void();" onclick="$('.width-thirty').hide();$('#floor-plans').slideDown(1000);">Floor Plans</a></li>
	    <li><a href="jacascript:void();" onclick="$('.width-thirty').hide();$('#availability').slideDown(1000);">Availability</a></li>
      </ul>
	  <div class="proj-enquiry">
	    <?php include("/manage/send-message.php");?>
      </div>
