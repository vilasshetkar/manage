...
<head>
    ...
    <link href="/manage/_script/Spray/SpryTabbedPanels.css" rel="stylesheet" type="text/css" />
<!-- InstanceEndEditable -->
...
-->
    ...
    <script src="/manage/_script/Spray/SpryTabbedPanels.js" type="text/javascript"></script>
    <!-- InstanceEndEditable -->
</head>
...
ftp_delete($conn, $_GET['del-file']) or die("Cannot Delete FTP file!");

// close the FTP stream
ftp_close($conn);
echo 'FTP file deleted.';
?>
<?php  }?>
...
<div id="TabbedPanels1" class="TabbedPanels">
  <ul class="TabbedPanelsTabGroup">
    <li class="TabbedPanelsTab" tabindex="0">Upload Images</li>
    <li class="TabbedPanelsTab" tabindex="0">Upload Videos</li>
    <li class="TabbedPanelsTab" tabindex="0">Upload Flash</li>
    <li class="TabbedPanelsTab" tabindex="0">Upload Audio</li>
    <li class="TabbedPanelsTab" tabindex="0">Upload Html Template / Text files</li>
  </ul>
  <div class="TabbedPanelsContentGroup">
    <div class="TabbedPanelsContent">
      <?php require('image-upload.php')?>
    </div>
    <div class="TabbedPanelsContent"><?php require('video-upload.php')?></div>
    <div class="TabbedPanelsContent">Content 3</div>
    <div class="TabbedPanelsContent">
      <?php require('audio-upload.php')?>
    </div>
    <div class="TabbedPanelsContent"><?php require('html-upload.php')?></div>
  </div>
</div>
<script type="text/javascript">
